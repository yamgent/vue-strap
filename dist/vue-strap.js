...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    noBackgroundStyle: function noBackgroundStyle() {
	      if (this.noBackground) {
	        return 'no-background';
	      }
	      return '';
	    },
	    noBorderStyle: function noBorderStyle() {
	      if (this.noBorder) {
	        return 'no-border';
	      }
	      return '';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    class: [_vm.boxStyle, _vm.addClass, _vm.lightStyle, _vm.seamlessStyle, _vm.noBackgroundStyle, _vm.noBorderStyle],
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.hasIcon && !_vm.headerBool),
	      expression: "hasIcon && !headerBool"
	    }],
	    staticClass: "icon-wrapper",
	    class: [_vm.iconStyle]
	  }, [_vm._t("icon", [_c('span', {
